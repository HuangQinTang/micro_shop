...
func (c *userApiService) GetUserInfo(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "UserApi.GetUserInfo", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func (h *userApiHandler) GetUserInfo(ctx context.Context, in *Request, out *Response) error {
	return h.UserApiHandler.GetUserInfo(ctx, in, out)
}
