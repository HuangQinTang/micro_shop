...
type CategoryService interface {
	...
	FindCategoryByLevel(ctx context.Context, in *FindByLevelReq, opts ...client.CallOption) (*FindAllRes, error)
	FindCategoryByParent(ctx context.Context, in *FindByParentReq, opts ...client.CallOption) (*FindAllRes, error)
...
func (c *categoryService) FindCategoryByLevel(ctx context.Context, in *FindByLevelReq, opts ...client.CallOption) (*FindAllRes, error) {
...
func (c *categoryService) FindCategoryByParent(ctx context.Context, in *FindByParentReq, opts ...client.CallOption) (*FindAllRes, error) {
...
type CategoryHandler interface {
	...
	FindCategoryByLevel(context.Context, *FindByLevelReq, *FindAllRes) error
	FindCategoryByParent(context.Context, *FindByParentReq, *FindAllRes) error
...
func RegisterCategoryHandler(s server.Server, hdlr CategoryHandler, opts ...server.HandlerOption) error {
	type category interface {
		...
		FindCategoryByLevel(ctx context.Context, in *FindByLevelReq, out *FindAllRes) error
		FindCategoryByParent(ctx context.Context, in *FindByParentReq, out *FindAllRes) error
...
func (h *categoryHandler) FindCategoryByLevel(ctx context.Context, in *FindByLevelReq, out *FindAllRes) error {
	return h.CategoryHandler.FindCategoryByLevel(ctx, in, out)
}

func (h *categoryHandler) FindCategoryByParent(ctx context.Context, in *FindByParentReq, out *FindAllRes) error {
