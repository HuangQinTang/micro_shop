...
type ProductService interface {
	AddProduct(ctx context.Context, in *ProductInfo, opts ...client.CallOption) (*AddProductRes, error)
...
func (c *productService) AddProduct(ctx context.Context, in *ProductInfo, opts ...client.CallOption) (*AddProductRes, error) {
...
type ProductHandler interface {
	AddProduct(context.Context, *ProductInfo, *AddProductRes) error
...
func RegisterProductHandler(s server.Server, hdlr ProductHandler, opts ...server.HandlerOption) error {
	type product interface {
		AddProduct(ctx context.Context, in *ProductInfo, out *AddProductRes) error
...
func (h *productHandler) AddProduct(ctx context.Context, in *ProductInfo, out *AddProductRes) error {
